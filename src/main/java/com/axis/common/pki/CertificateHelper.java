...
public class CertificateHelper {
	...
	private static String KEY_STORE = "PKCS12";
	 ...
	 * @throws Exception
	 */
	private static PrivateKey getPrivateKey(String keyStorePath, String keyStorePassword, String alias,
	 ...
	 * @throws Exception
	 */
	private static Certificate getCertificate(String keyStorePath, String keyStorePassword, String alias)
			throws Exception {
		KeyStore ks = getKeyStore(keyStorePath, keyStorePassword);
	 ...
	 * @throws Exception
	 */
	public static String getAlias(String keyStorePath, String password) throws Exception
	{
		Enumeration<String> aliass = getKeyStore(keyStorePath, password).aliases();
		while(aliass.hasMoreElements())
			return aliass.nextElement();
		return null;
	}
	 ...
	 * @throws Exception
	 */
	public static byte[] sign(byte[] sign, String keyStorePath, String alias, String keyStorePassword,
			String aliasPassword) throws Exception {
		// 获得证书
